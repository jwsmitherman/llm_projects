...
__BUILD_VERSION__ = "2026-05-20-v6.7-better-throttle-handling"
...
MAX_RETRIES       = int(os.getenv("MAX_RETRIES", "10"))    # Was 5 - 429s need more retries
BASE_BACKOFF_S    = float(os.getenv("BASE_BACKOFF_S", "3.0"))  # Was 2.0 - longer waits
MAX_BACKOFF_S     = float(os.getenv("MAX_BACKOFF_S", "60.0"))  # NEW - cap exponential growth
MAX_CONCURRENCY   = int(os.getenv("MAX_CONCURRENCY", "2"))     # Was 4 - keep low to avoid TPM walls
