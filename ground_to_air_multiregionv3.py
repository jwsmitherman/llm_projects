...
TARGETS = [
    ...
    {"region":"Northeast", "base":"MTC Colona (Medforce I)",     "county":"Macon",       "state":"Illinois"},
    ...
    {"region":"Northeast", "base":"MTC Burlington (Medforce II)","county":"Floyd",       "state":"Iowa"},
    {"region":"Northeast", "base":"MTC Burlington (Medforce II)","county":"Buchanan",    "state":"Iowa"},
...
def norm_county(v):
    ...
    # collapse St / St. / Saint variants (Illinois shows all three for St Clair)
    s = re.sub(r"^(st\.?|saint)\s+", "St ", s, flags=re.I)
