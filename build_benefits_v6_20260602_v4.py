...
__BUILD_VERSION__ = "2026-05-27-v6.15-canonical-section-codes"


# ----------------------------------------------------------------------------
# Configuration - HARDCODED for local dev use (comissio-poc, 4M TPM)
# ----------------------------------------------------------------------------
# WARNING: credentials are hardcoded below. Do NOT commit this file to git,
# do NOT share screenshots of it, and rotate the key in Azure Portal if it
# is ever exposed. This is intended as a throwaway local script only.
AZURE_OPENAI_ENDPOINT    = "https://comissio-poc.openai.azure.com/"
AZURE_OPENAI_API_KEY     = "PASTE_YOUR_COMISSIO_KEY_HERE"   # <-- paste the key from Azure Portal
AZURE_OPENAI_DEPLOYMENT  = "gpt-5-mini-ng"
AZURE_OPENAI_API_VERSION = "2024-12-01-preview"
AZURE_OPENAI_TEMPERATURE: Optional[float] = None  # gpt-5 family rejects explicit temp

# gpt-5-mini consumes completion tokens for internal reasoning before output.
LLM_MAX_TOKENS    = 4000
...
# Concurrency - comissio supports 4M TPM so we run high.
MAX_CONCURRENCY   = 16
CONCURRENT_PLANS  = 4
...
SECTION_CODE_TO_BENEFIT_ID = {
    # ----- Inpatient / facility (canonical: 800=Inpatient Hospital, 810=Inpatient Mental Health, 820=SNF) -----
    "1a":   800, "1a1":  800, "1a2":  800,
    "1b":   810,
    "2":    820,
    # ----- Cardiac/Pulmonary Rehab (3): no separate canonical benefit, group under 830 outpatient -----
    "3":    830, "3-1": 830, "3-2": 830, "3-3": 830, "3-4": 830,
    # ----- Emergency / Urgent / Worldwide (4): 981=Emergency, 982=Urgent, 1800=Worldwide Transport -----
    "4a":   981, "4a1":  981, "4a2":  981,
    "4b":   982,
    "4c":  1800, "4c1": 1800, "4c2": 1800, "4c3": 1800,    # Worldwide emergency/urgent/transport
    # ----- Partial Hospitalization / Intensive OP (5): outpatient services -----
    "5a":   950, "5b":   950,
    # ----- Home Health (6) = Outpatient Rehabilitation 990 / Hearing Services 1400? -----
    # System prompt has Hearing=1400, Home Health is closest to 1060(Meals) or general
    # Looking at output, screenshot shows 830=Home Health, so 6 -> 830
    "6":    830,
    # ----- Professional services (7): 900=PCP, 910=Specialist, 911=Telehealth, 920=Chiro, 930=Podiatry, 940=Mental Health, 950=Substance Abuse, 990=Rehab -----
    "7a":   900,
    "7b":   920,
    "7c":   990, "7i":   990,    # Occupational Therapy + PT/Speech = 990 Outpatient Rehab
    "7d":   910,
    "7e":   940, "7e1":  940, "7e2":  940,    # Mental Health
    "7f":   930,                              # Podiatry
    "7g":   910,                              # Other Health Care Professional = Specialist
    "7h":   940, "7h1":  940, "7h2":  940,    # Psychiatric -> Mental Health
    "7j":   911,                              # Additional Telehealth
    "7k":   950,                              # Opioid Treatment -> Substance Abuse
    # ----- Diagnostics / tests (8): 1030 -----
    "8a":  1030, "8a1": 1030, "8a2": 1030,
    "8b":  1030, "8b1": 1030, "8b2": 1030, "8b3": 1030,
    # ----- Outpatient hospital (9): 981=Outpatient Hospital, 982=Observation, 970=ASC, 960=Substance Abuse -----
    "9a":   981, "9a1":  981, "9a2":  982,
    "9b":   970,                              # Ambulatory Surgical Center
    "9c":   950, "9c1":  950, "9c2":  950,    # Outpatient Substance Abuse
    "9d":   981,                              # Outpatient Blood
    # ----- DME, Supplies, Diabetic (10, 11, 12) -----
    "10a":  970, "10a1":  970, "10a2":  970,  # Ambulance -> 970
    "11a": 1000,                              # DME -> 1000
    "11b": 1610, "11b1": 1610, "11b2": 1610,  # Prosthetic Devices, Medical Supplies -> 1610
    "11c": 1020, "11c1": 1020, "11c2": 1020,  # Diabetic Supplies -> 1020
    "12":  1200,                              # Dialysis
    # ----- Extras (13): 1900=Acupuncture, 2100=OTC, 1060=Meals -----
    "13a": 1900,                              # Acupuncture
    "13b": 2100,                              # OTC Items
    "13c": 1060,                              # Meal Benefit
    # ----- Preventive / Defined Supplemental (14): 1700=Preventive, 1050=Fitness, mostly -----
    "14a": 1700,                              # Medicare-covered Zero Dollar Preventive
    "14b": 1700,                              # Annual Physical Exam
    "14c": 1700, "14c4": 1050, "14c7": 1700,  # Other Defined Supplemental (14c4=Fitness)
    "14d": 1200,                              # Kidney Disease Education
    "14e1":1700, "14e2":1020, "14e4":1700, "14e5":1700,  # 14e2=Diabetes Self-Mgmt Training -> 1020
    # ----- Medicare Part B Drugs (15) -----
    "15":   760, "15-1": 755, "15-2": 760, "15-3": 760,
    # ----- Dental (16): 1300=Dental Services (Medicare), 1301=Dental Comprehensive (Non-Medicare) -----
    "16a": 1300,                              # Medicare Dental Services
    "16b": 1301, "16b1": 1301, "16b2": 1301, "16b3": 1301, "16b4": 1301, "16b6": 1301,
    "16c": 1301, "16c1": 1301, "16c2": 1301, "16c3": 1301, "16c4": 1301,
    "16c5": 1301, "16c7": 1301, "16c8": 1301, "16c10": 1301,
    # ----- Vision (17): 1700=Eye Exams (Medicare), 1500=Eyewear/Vision Services (Non-Medicare) -----
    "17a": 1700, "17a1": 1500,                # Eye Exams Medicare->1700, Routine->1500
    "17b": 1500, "17b1": 1500, "17b2": 1500, "17b3": 1500, "17b4": 1500,  # All eyewear/lenses/frames
    # ----- Hearing (18): 1400=Hearing Services -----
    "18a": 1400, "18a1": 1400, "18a2": 1400,
    "18b": 1400, "18b1": 1400,
    "18c": 1400,                              # OTC Hearing Aids
    # ----- VBID/SSBCI (19) -----
    "19a":  670, "19b":  670,                 # Optional supplemental
}
...
PLAN_LEVEL_CATEGORIES = {
    # ----- MOOP -----
    # (HMO Plan), (Local PPO Plan), (Regional PPO Plan) variants all exist
    "Contract Year 2026 Medicare-defined MOOP Limits (HMO Plan)":       700,
    "Contract Year 2026 Medicare-defined MOOP Limits (HMOPOS Plan)":    700,
    "Contract Year 2026 Medicare-defined MOOP Limits (Local PPO Plan)": 700,
    "Contract Year 2026 Medicare-defined MOOP Limits (Regional PPO Plan)": 700,
    "Contract Year 2026 Medicare-defined MOOP Limits (PFFS Plan)":      700,
    "LPPO/RPPO Max Enrollee Cost Limit":                                700,
    "HMO/HMOPOS Max Enrollee Cost Limit":                               700,

    # ----- Deductible (benefit 610) -----
    "Annual Plan Deductible LPPO/RPPO":                                 610,
    "Annual Plan Deductible HMO/HMOPOS":                                610,
    "Deductible for LPPO/RPPO Mandatory Supplemental Benefits":         610,
    "Deductible for HMO/HMOPOS Mandatory Supplemental Benefits":        610,

    # ----- Plan-level info / attributes (benefit 620 - plan description) -----
    "General Information":                                              620,
    "Plan Attributes":                                                  620,
    "Plan Details":                                                     620,
    "Special Needs Plan":                                               620,
    "VBID":                                                             620,

    # ----- Cost sharing summary (benefit 630) -----
    "Plan Level Cost Sharing.Combined Supplemental Benefits":           630,
    "Plan Level Cost Sharing.Reductions in Cost Sharing":               630,
    "Plan Level Cost Sharing.Tiered Cost Sharing":                      630,
    "Reduction in Cost Sharing Groups":                                 630,
    "Combined Benefits Groups":                                         630,

    # ----- Rx Setup (benefit 710) -----
    "Rx Setup":                                                         710,
    ...
    # ----- Rx Tier Locations (benefit 700 - tier names/structure) -----
    "Rx Tier Locations.Standard/Preferred Mail-Order":                  700,
    "Rx Tier Locations.Standard/Preferred Retail":                      700,

    # ----- Rx Tier 1 (Preferred Generic) - benefit 711 (initial coverage) -----
    "Rx Tier 1 - Preferred Generic.Long Term Care":                     711,
    "Rx Tier 1 - Preferred Generic.Out of Network":                     711,
    "Rx Tier 1 - Preferred Generic.Standard/Preferred Mail-Order":      711,
    "Rx Tier 1 - Preferred Generic.Standard/Preferred Retail":          711,
    "Rx Tier 1 - Preferred Generic.Tier Drug Type(s)":                  711,
    "Rx Tier 1 Initial Coverage Phase - Preferred Generic":             711,
    "Rx Tier 1 Initial Coverage Phase - Preferred Generic.Cost-Share Structure": 711,
    "Rx Tier 1 Initial Coverage Phase - Preferred Generic.Long Term Care": 711,
    "Rx Tier 1 Initial Coverage Phase - Preferred Generic.Out of Network": 711,
    "Rx Tier 1 Post OOP - Preferred Generic":                           730,
    "Rx Tier 1 Post OOP - Preferred Generic.Cost-Share Structure":      730,

    # ----- Rx Tier 2 (Generic) - benefit 712 -----
    "Rx Tier 2 - Generic.Long Term Care":                               712,
    "Rx Tier 2 - Generic.Out of Network":                               712,
    "Rx Tier 2 - Generic.Standard/Preferred Mail-Order":                712,
    "Rx Tier 2 - Generic.Standard/Preferred Retail":                    712,
    "Rx Tier 2 - Generic.Tier Drug Type(s)":                            712,
    "Rx Tier 2 Initial Coverage Phase - Generic":                       712,
    "Rx Tier 2 Initial Coverage Phase - Generic.Cost-Share Structure":  712,
    "Rx Tier 2 Initial Coverage Phase - Generic.Long Term Care":        712,
    "Rx Tier 2 Initial Coverage Phase - Generic.Out of Network":        712,
    "Rx Tier 2 Post OOP - Generic":                                     730,
    "Rx Tier 2 Post OOP - Generic.Cost-Share Structure":                730,

    # ----- Rx Tier 3 (Preferred Brand) -----
    "Rx Tier 3 - Preferred Brand.Long Term Care":                       712,
    "Rx Tier 3 - Preferred Brand.Out of Network":                       712,
    "Rx Tier 3 - Preferred Brand.Standard/Preferred Mail-Order":        712,
    "Rx Tier 3 - Preferred Brand.Standard/Preferred Retail":            712,
    "Rx Tier 3 - Preferred Brand.Tier Drug Type(s)":                    712,
    "Rx Tier 3 Initial Coverage Phase - Preferred Brand":               712,
    "Rx Tier 3 Initial Coverage Phase - Preferred Brand.Cost-Share Structure": 712,
    "Rx Tier 3 Initial Coverage Phase - Preferred Brand.Long Term Care": 712,
    "Rx Tier 3 Initial Coverage Phase - Preferred Brand.Out of Network": 712,
    "Rx Tier 3 Post OOP - Preferred Brand":                             730,
    "Rx Tier 3 Post OOP - Preferred Brand.Cost-Share Structure":        730,

    # ----- Rx Tier 4 (Non-Preferred Drug) - benefit 740 -----
    "Rx Tier 4 - Non-Preferred Drug.Long Term Care":                    740,
    "Rx Tier 4 - Non-Preferred Drug.Out of Network":                    740,
    "Rx Tier 4 - Non-Preferred Drug.Standard/Preferred Mail-Order":     740,
    "Rx Tier 4 - Non-Preferred Drug.Standard/Preferred Retail":         740,
    "Rx Tier 4 - Non-Preferred Drug.Tier Drug Type(s)":                 740,
    "Rx Tier 4 Initial Coverage Phase - Non-Preferred Drug":            740,
    "Rx Tier 4 Initial Coverage Phase - Non-Preferred Drug.Cost-Share Structure": 740,
    "Rx Tier 4 Initial Coverage Phase - Non-Preferred Drug.Long Term Care": 740,
    "Rx Tier 4 Initial Coverage Phase - Non-Preferred Drug.Out of Network": 740,
    "Rx Tier 4 Post OOP - Non-Preferred Drug":                          740,
    "Rx Tier 4 Post OOP - Non-Preferred Drug.Cost-Share Structure":     740,

    # ----- Rx Tier 5 (Specialty Tier) -----
    "Rx Tier 5 - Specialty Tier.Long Term Care":                        740,
    "Rx Tier 5 - Specialty Tier.Out of Network":                        740,
    "Rx Tier 5 - Specialty Tier.Standard/Preferred Mail-Order":         740,
    "Rx Tier 5 - Specialty Tier.Standard/Preferred Retail":             740,
    "Rx Tier 5 - Specialty Tier.Tier Drug Type(s)":                     740,
    "Rx Tier 5 Initial Coverage Phase - Specialty Tier":                740,
    "Rx Tier 5 Initial Coverage Phase - Specialty Tier.Cost-Share Structure": 740,
    "Rx Tier 5 Initial Coverage Phase - Specialty Tier.Long Term Care": 740,
    "Rx Tier 5 Initial Coverage Phase - Specialty Tier.Out of Network": 740,
    "Rx Tier 5 Post OOP - Specialty Tier":                              740,
    "Rx Tier 5 Post OOP - Specialty Tier.Cost-Share Structure":         740,

    # ----- Rx Insulin (benefit 755) -----
    "Rx Insulin":                                                       755,
    "Rx Insulin Tier 1 - Preferred Generic.Long Term Care":             755,
    "Rx Insulin Tier 1 - Preferred Generic.Out-of-Network":             755,
    "Rx Insulin Tier 1 - Preferred Generic.Preferred Mail-Order":       755,
    "Rx Insulin Tier 1 - Preferred Generic.Preferred Retail":           755,
    "Rx Insulin Tier 1 - Preferred Generic.Standard Mail-Order":        755,
    "Rx Insulin Tier 1 - Preferred Generic.Standard Retail":            755,
    "Rx Insulin Tier 2 - Generic.Long-Term Care":                       755,
    "Rx Insulin Tier 2 - Generic.Out-of-Network":                       755,
    "Rx Insulin Tier 2 - Generic.Preferred Mail-Order":                 755,
    "Rx Insulin Tier 2 - Generic.Preferred Retail":                     755,
    "Rx Insulin Tier 2 - Generic.Standard Mail-Order":                  755,
    "Rx Insulin Tier 2 - Generic.Standard Retail":                      755,
    "Rx Insulin Tier 3 - Preferred Brand.Long-Term Care":               755,
    "Rx Insulin Tier 3 - Preferred Brand.Out-of-Network":               755,
    "Rx Insulin Tier 3 - Preferred Brand.Preferred Mail-Order":         755,
    "Rx Insulin Tier 3 - Preferred Brand.Preferred Retail":             755,
    "Rx Insulin Tier 3 - Preferred Brand.Standard Mail-Order":          755,
    "Rx Insulin Tier 3 - Preferred Brand.Standard Retail":              755,
    "Rx Insulin Tier 4 - Non-Preferred Drug.Long-Term Care":            755,
    "Rx Insulin Tier 4 - Non-Preferred Drug.Out-of-Network":            755,
    "Rx Insulin Tier 4 - Non-Preferred Drug.Preferred Mail-Order":      755,
    "Rx Insulin Tier 4 - Non-Preferred Drug.Preferred Retail":          755,
    "Rx Insulin Tier 4 - Non-Preferred Drug.Standard Mail-Order":       755,
    "Rx Insulin Tier 4 - Non-Preferred Drug.Standard Retail":           755,
    "Rx Insulin Tier 5 - Specialty Tier":                               755,

    # ----- Standard Bid (benefit 600) -----
    "Standard Bid":                                                     600,

    # ----- Optional supplemental packages -----
    "Optional Supplemental Packages":                                   670,
    "Optional Supplemental Packages.Additional OON cost share information": 670,

    # ----- Misc plan-level fields -----
    "Prior Authorization":                                              620,
    "Referral":                                                         620,
    "Visitor Travel":                                                   620,
    "VBID/MA UF/SSBCI Additional Benefits Packages (19b)":              620,
    "VBID/MA UF/SSBCI Reduction in Cost Sharing Packages (19a)":        620,

    # Transportation services that don't carry a section code
    "Transportation Services -  Plan Approved Health-related Locations": 1800,
    "Transportation Services - Plan Approved Health-related Locations":  1800,
    "Non-Medicare Services.Transportation Services -  Plan Approved Health-related Locations": 1800,
    "Non-Medicare Services.Transportation Services - Plan Approved Health-related Locations":  1800,
}
...
def _keyword_fallback_match(cat: str) -> Optional[int]:
    """
    Last-resort fuzzy match for categories that use variant strings across
    different plan types (HMO vs PPO vs PFFS). Returns benefit_id or None.

    Only matches plan-level categories - section-code categories should already
    have been handled by SECTION_CODE_TO_BENEFIT_ID.
    """
    cat_lower = cat.lower()
    # Deductible variants - benefit 610
    if "deductible" in cat_lower and "rx" not in cat_lower:
        return 610
    # MOOP variants - benefit 700
    if "moop" in cat_lower or "max enrollee cost limit" in cat_lower:
        return 700
    # Rx Tier variants we might have missed
    if "rx tier" in cat_lower or "rx insulin tier" in cat_lower:
        # Tier 1 -> 711, Tier 2/3 -> 712, Tier 4/5 -> 740
        if "tier 1" in cat_lower or "tier 2" in cat_lower or "tier 3" in cat_lower:
            return 711 if "tier 1" in cat_lower else 712
        if "tier 4" in cat_lower or "tier 5" in cat_lower:
            return 740
    # Rx general
    if cat_lower.startswith("rx "):
        return 710
    # Plan-level meta
    if cat_lower in ("general information", "plan details", "plan attributes",
                     "prior authorization", "referral", "special needs plan",
                     "vbid", "visitor travel"):
        return 620
    # Transportation variants
    if "transportation" in cat_lower:
        return 1800
    return None


def _group_rows_by_benefit(plan_rows: pd.DataFrame,
                            log_unmapped: bool = True) -> dict[tuple[int, bool], BenefitGroup]:
    """
    Walk every row in this plan, tag with (benefit_id, is_oon), and group.
    Returns: {(benefit_id, is_oon): BenefitGroup}

    log_unmapped: if True, prints a summary of categories that didn't match any
                  benefit ID. These rows the LLM never sees - if a benefit is
                  missing from output, the answer is in this log.
    """
    ...
    for idx, row in plan_rows.iterrows():
        ...
        # 4. Keyword fallback - last resort for variant strings (HMO vs PPO vs PFFS)
        fb_bid = _keyword_fallback_match(cat)
        if fb_bid is not None:
            tagged_rows.append((fb_bid, oon, idx))
            continue

        # Otherwise this row is dropped - track for diagnostics
        if cat:
    ...
    # Log unmapped categories so we can see what's being dropped
    if log_unmapped and unmapped_categories:
        n_dropped = sum(unmapped_categories.values())
        n_cats = len(unmapped_categories)
        print(f"  [unmapped] {n_dropped} input row(s) across {n_cats} categor(ies) were dropped:")
        for cat, count in sorted(unmapped_categories.items(), key=lambda x: -x[1])[:20]:
            print(f"    {count:>4}  {cat[:100]}")
        if n_cats > 20:
            print(f"    ... and {n_cats - 20} more")
...
# Field patterns that carry actual cost / amount / limit information.
# Rows whose field name contains these words are prioritized for the LLM.
COST_BEARING_FIELDS = [
    "copayment", "coinsurance", "amount", "percentage", "premium",
    "deductible", "maximum", "minimum", "moop", "cost-share", "cost share",
    "tier", "supply", "periodicity", "indicate number of visit",
    "indicate limit", "indicate quantity", "begin day", "end day",
    "is this benefit unlimited", "combined maximum",
]

# Fields that are useful as ANCHORS - they tell the LLM what kind of cost
# structure to look for, even though they're yes/no themselves.
ANCHOR_FIELDS = [
    "is there a copayment", "is there a coinsurance",
    "is this benefit covered", "is this benefit unlimited",
]

# Fields that are pure boilerplate / authorization metadata - skip these.
BOILERPLATE_FIELDS = [
    "authorization", "referral", "prior auth",
    "indicate if there is", "does the plan", "do the benefits",
]


def _is_cost_bearing(field: str) -> bool:
    f = field.lower() if isinstance(field, str) else ""
    return any(p in f for p in COST_BEARING_FIELDS)


def _is_anchor(field: str) -> bool:
    f = field.lower() if isinstance(field, str) else ""
    return any(p in f for p in ANCHOR_FIELDS)


def _is_boilerplate(field: str) -> bool:
    f = field.lower() if isinstance(field, str) else ""
    return any(p in f for p in BOILERPLATE_FIELDS)


def _filter_and_sort_rows_for_llm(rows: pd.DataFrame, max_rows: int = 30) -> pd.DataFrame:
    """
    Filter input rows to those most useful to the LLM and sort them so cost
    information appears first. Caps the count to keep prompts focused.

    Order: cost-bearing rows first, then anchor rows, then anything else
    (except pure boilerplate which is dropped).
    """
    if rows.empty:
        return rows
    ...
    def classify(row):
        f = row.get("field", "")
        if _is_cost_bearing(f):
            return 0
        if _is_anchor(f):
            return 1
        if _is_boilerplate(f):
            return 9  # drop
        return 2  # keep but lower priority

    rows = rows.copy()
    rows["_priority"] = rows.apply(classify, axis=1)
    rows = rows[rows["_priority"] < 9]   # drop boilerplate
    rows = rows.sort_values("_priority", kind="stable")
    rows = rows.head(max_rows)
    return rows.drop(columns=["_priority"])


def _build_user_message_for_benefit(base_row: dict) -> str:
    """
    Compact input for the LLM: which benefit, plus the most relevant input rows.

    Filters out boilerplate, prioritizes cost-bearing fields. The LLM should
    see cost data first, anchor rows second, supporting context third.
    """
    group_rows: pd.DataFrame = base_row["_group_rows"]
    filtered = _filter_and_sort_rows_for_llm(group_rows)
    ...
    payload_lines.append(
        f"Input rows ({len(filtered)} of {len(group_rows)} relevant; cost data first):"
    )
    for _, r in filtered.iterrows():
        ...
        payload_lines.append(f"  [{cat[:60]}] {fld} = {val}")
